...
app.use(cors({
   origin: 'https://aifusion-project-cbs4t6ig6-lata-bansavades-projects.vercel.app', // Allow requests from this origin
  // origin: 'http://localhost:3000', // Allow requests from this origin
  credentials: true // Allow credentials (cookies, authorization headers, etc.)
}));
//CORS Middleware
const corsMiddleware = (req, res, next) => {
    res.setHeader('Access-Control-Allow-Origin', 'https://aifusion-project-cbs4t6ig6-lata-bansavades-projects.vercel.app');
